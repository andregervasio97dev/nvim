...
wk.add({
	...
	-- Normal mode keymaps
	{
		...
		{ "<leader>hh", "<cmd>vert help<cr>", desc = "Opens help on vertical split" },
		{ "<leader>t",  group = "tab" },
		{
		...
		{
			{ "<leader>sv", "<cmd>vsplit new<cr>", desc = "Split window vertically on new" },
		}
	},
	-- Insert mode keymaps
	{
		...
		{ "<c-space>", function() vim.lsp.completion.get() end, desc = "Get LSP completion suggestion" },
	},
})
